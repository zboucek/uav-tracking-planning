...
if test:
    ...
    DEFAULT_OUTPUT_FOLDER = 'results/3d_pybullet_faster/data/'
    DEFAULT_COLAB = False
    SAVE_RESULTS = False
    CTRL_TYPE = "ic"
    SAVE_FOLDER = "results/3d_pybullet_faster/data/"
else:
    DEFAULT_DRONES = DroneModel("cf2p")
    # DEFAULT_DRONES = DroneModel("hb")
    DEFAULT_NUM_DRONES = 1
...
def run(
    ...
    if drone in [DroneModel.CF2X, DroneModel.CF2P]:
        ctrl = [ControlCascade(CTRL_TYPE, models, True, True) for i in range(num_drones)]
