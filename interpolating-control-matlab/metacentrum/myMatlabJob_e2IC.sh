#!/bin/bash
#PBS -N UAV-explicit-2IC
#PBS -l walltime=12:00:00
#PBS -l select=1:ncpus=14:mem=16gb:scratch_local=10gb
...
matlab -nodesktop -r "run run_mpt_script_explicit_2ic;"
...
cp -a data/explicit_2ic/. $DATADIR/explicit_2ic/ || export CLEAN_SCRATCH=false
