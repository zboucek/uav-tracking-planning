#!/bin/bash
#PBS -N UAV-explicit-IC
#PBS -l walltime=6:00:00
#PBS -l select=1:ncpus=14:mem=8gb:scratch_local=6gb
...
matlab -nodesktop -r "run run_mpt_script_explicit_ic;"
...
cp -a data/explicit_ic/. $DATADIR/explicit_ic/ || export CLEAN_SCRATCH=false
