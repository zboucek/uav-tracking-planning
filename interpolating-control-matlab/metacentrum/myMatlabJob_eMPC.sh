#!/bin/bash
#PBS -N UAV-explicit-MPC
#PBS -l walltime=12:00:00
#PBS -l select=1:ncpus=14:mem=32gb:scratch_local=30gb
#PBS -l matlab=1
...
matlab -nodesktop -r "run run_mpt_script_explicit_mpc;"
...
cp -a data/explicit_mpc/. $DATADIR/explicit_mpc/ || export CLEAN_SCRATCH=false
