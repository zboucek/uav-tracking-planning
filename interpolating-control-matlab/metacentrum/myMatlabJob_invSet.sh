#!/bin/bash
#PBS -N UAV-invariant-set
#PBS -l walltime=6:00:00
#PBS -l select=1:ncpus=6:mem=16gb:scratch_local=6gb
#PBS -l matlab=1
...
matlab -nodesktop -r "run run_mpt_script_invSet;"
...
cp -a output/. $DATADIR/invariant_set/ || export CLEAN_SCRATCH=false
