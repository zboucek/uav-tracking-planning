#!/bin/bash
#PBS -N UAV-explicit-MPC-phi
#PBS -l walltime=2:00:00
#PBS -l select=1:ncpus=6:mem=16gb:scratch_local=30gb
#PBS -l matlab=1
...
matlab -nodesktop -r "run run_mpt_script_getNMPC_phi;"
...
cp -a data/explicit_mpc/phi/. $DATADIR/eMPC_phi/ || export CLEAN_SCRATCH=false
