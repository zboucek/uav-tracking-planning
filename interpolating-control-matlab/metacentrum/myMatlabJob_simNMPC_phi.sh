#!/bin/bash
#PBS -N UAV-explicit-MPC-phi-sim
...
matlab -nodesktop -singleCompThread -r "run run_mpt_script_simNMPC_phi;"
...
cp -a sim/phi_output/. $DATADIR/phi_output/ || export CLEAN_SCRATCH=false
