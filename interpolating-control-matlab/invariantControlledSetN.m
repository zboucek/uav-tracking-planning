function [P] = invariantControlledSetN(varargin)
%invariantControlledSetN Computes N-step inveriant controlled set
...
while 1
    % expand set to Ptemp
    Ptemp = Polyhedron([P.A*([system.A,system.B]);eye(system.nx+system.nu);-eye(system.nx+system.nu)],[P.b;system.x.max;system.u.max;-system.x.min;-system.u.min]);
